...
int PlayScene::ScoreForWinner = 0;
...
void PlayScene::OnKeyDown(int keyCode) {
    ...
    if (keyCode == ALLEGRO_KEY_TAB) {
        ...
        if (keyStrokes.size() == code.size() && std::equal(keyStrokes.begin(), keyStrokes.end(), code.begin(), code.end())) {
            keyStrokes.clear();
...
void PlayScene::ScoreUp() {
    scores++;
    // UIScore->Text = std::string("Score ") + std::to_string(scores);
    UIScore->Text = std::string("Score ") + std::to_string(scores);
}
void PlayScene::Hit() {
    lives--;
...
void PlayScene::ConstructUI() {
    ...
    UIGroup->AddNewObject(UIScore = new Engine::Label(std::string("Score ") + std::to_string(scores), "pirulen.ttf", 24, 1294, 128));//初始化UiScore
    TurretButton *btn;
    // Button 1
    btn = new TurretButton("play/floor.png", "play/dirt.png",
                           Engine::Sprite("play/tower-base.png", 1294, 162, 0, 0, 0, 0),
                           Engine::Sprite("play/turret-1.png", 1294, 162 - 8, 0, 0, 0, 0), 1294, 162, MachineGunTurret::Price);
    // Reference: Class Member Function Pointer and std::bind.
    btn->SetOnClickCallback(std::bind(&PlayScene::UIBtnClicked, this, 0));
    UIGroup->AddNewControlObject(btn);
    // Button 2
    btn = new TurretButton("play/floor.png", "play/dirt.png",
                           Engine::Sprite("play/tower-base.png", 1370, 162, 0, 0, 0, 0),
                           Engine::Sprite("play/turret-2.png", 1370, 162 - 8, 0, 0, 0, 0), 1370, 162, LaserTurret::Price);
